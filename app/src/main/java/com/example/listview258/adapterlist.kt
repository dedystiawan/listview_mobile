...
class adapterlist (var mCtx: Context, var resource:Int, var items:List<tipe>)
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val textView: TextView = view.findViewById(R.id.nama)
        val textView1: TextView = view.findViewById(R.id.penjelasan)
